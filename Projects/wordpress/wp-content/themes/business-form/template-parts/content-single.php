...
$hide_show_feature_image = business_form_get_option('business_form_show_feature_image_single_option');
...
<article id="post-<?php the_ID(); ?>"
    ...
    <div class="entry-meta meta-data">
        ...
        <span class="category-tag">
            ...
            <a href="">
                <?php business_form_entry_footer(); ?>
            </a>
        </span>
    </div>
    ...
    <div class="entry-content">
        ...
        wp_link_pages(array(
            'before' => '<div class="page-links">' . esc_html__('Pages:', 'business-form'),
            'after' => '</div>',
        ));
