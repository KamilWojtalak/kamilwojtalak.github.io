<?php
if (!class_exists('Business_Form_Service_Widget')) {
    class Business_Form_Service_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Services', 'business-form'),
                'sub-title' => '',
                'resources' => '',
                'section-id' =>'',
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('AT : Services Widget', 'business-form'),
                array('description' => esc_html__('Business Services Section', 'business-form'))
            );
        }
...
add_action('widgets_init', 'business_form_services_widget');
function business_form_services_widget()
{
    register_widget('Business_Form_Service_Widget');
