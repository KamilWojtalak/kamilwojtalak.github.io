<?php
if (!class_exists('Business_Form_Testimonials_Widget')) {
    class Business_Form_Testimonials_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Testimonials', 'business-form'),
                'sub-title' => '',
                'resources' => '',
                'features_background' => '',
                'section-id' =>'',
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('AT : Testimonials Widget', 'business-form'),
                array('description' => esc_html__('Business Testimonials Section', 'business-form'))
            );
        }
        public function form( $instance )
        {
            ...
            <p>
                ...
                <span class="img-preview-wrap" <?php  if ( empty( $features_background ) ){ ?> style="display:none;" <?php  } ?>>
                    <img class="widefat" src="<?php echo esc_url( $features_background ); ?>" alt="<?php esc_attr_e( 'Image preview', 'business-form' ); ?>"  />
                ...
                <input type="button" id="custom_media_button"  value="<?php esc_attr_e( 'Upload Image', 'business-form' ); ?>" class="button media-image-upload" data-title="<?php esc_attr_e( 'Select Background Image','business-form'); ?>" data-button="<?php esc_attr_e( 'Select Background Image','business-form'); ?>"/>
                <input type="button" id="remove_media_button" value="<?php esc_attr_e( 'Remove Image', 'business-form' ); ?>" class="button media-image-remove" />
            </p>
            <?php
        }
...
add_action('widgets_init', 'business_form_testimonials_widget');
function business_form_testimonials_widget()
{
    register_widget('Business_Form_Testimonials_Widget');
