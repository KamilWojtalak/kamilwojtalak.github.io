...
if(isset($_POST['submit'])){
    $to = "poselkillionmunyama@gmail.com"; // this is your Email address
        ...
        <section class="first-section section">
            <div class="first-section__first-part">
                <div class="first-part__bgimage">
                    <img class="first-part__image" src="<?php echo get_template_directory_uri()?>/images/FirstImage.png" alt="Kyllion"> 
            ...
            <div class="first-section__second-part">
                <div class="first-part__bgimage">
                    <img class="second-part__image" src="<?php echo get_template_directory_uri()?>/images/FirstImage.jpg" alt="Kyllion"> 
            ...
            <section class="section no-select" id="o-mnie">
                <div class="section__first-part">
                    <ul class="first-part__list">
                        <li class="first-part__item"><a href="#section__second__part" class="first-section__link text-blue">samorządy </a></li>
                        <li class="first-part__item"><a href="#section__second__part" class="first-section__link text-blue">przedsiębiorczość</a></li>
                        <li class="first-part__item"><a href="#section__second__part" class="first-section__link text-blue">stosunki międzynarodowe</a></li>
                        <li class="first-part__item"><a href="#section__second__part" class="first-section__link text-blue">o mnie</a></li>
                    </ul>
                </div>
                <div class="section__second-part section__place-for-description" id='section__second__part'>
                    <img class="second-part__image" src="<?php echo get_template_directory_uri()?>/images/ThirdImage.jpg" alt="Kyllion">
            ...
            <section class="section no-select" id="program">
                <div class="section__first-part">
                    ...
                    viewBox="0 0 764.17 842" style="enable-background:new 0 0 764.17 842;" xml:space="preserve">
                        ...
                        <a href="#program" xlink:title='Powiat złotowski' class="program__map map__powiat-zlotowski">
                        ...
                        <a href="#program" xlink:title='Powiat pilski' class="program__map map__powiat-pilski">
                        ...
                        <a href="#program" xlink:title='Powiat chodzieski' class="program__map map__powiat-chodzieski">
                        ...
                        <a href="#program" xlink:title='Powiat czarnkowsko-trzcianecki' class="program__map map__powiat-czarnkowsko-trzcianecki">
                        ...
                        <a href="#program" xlink:title='Powiat międzychodzki' class="program__map map__powiat-miedzychodzki">
                        ...
                        <a href="#program" xlink:title='Powiat szamotulski' class="program__map map__powiat-szamotulski">
                        ...
                        <a href="#program" xlink:title='Powiat obornicki' class="program__map map__powiat-obornicki">
                        ...
                        <a href="#program" xlink:title='Powiat wągrowiecki' class="program__map map__powiat-wagrowiecki">
                        ...
                        <a href="#program" xlink:title='Powiat nowotomyski' class="program__map map__powiat-nowotomyski">
                        ...
                        <a href="#program" xlink:title='Powiat wolsztyński' class="program__map map__powiat-wolsztynski">
                        ...
                        <a href="#program" xlink:title='Powiat grodziski' class="program__map map__powiat-grodziski">
            ...
            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FKMMunyama%2F&tabs=timeline&width=500&height=650&small_header=false&adapt_container_width=false&hide_cover=false&show_facepile=true&appId=404321486996278" width="500" height="650" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>                <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FKMMunyama%2Fposts%2F2121455484627598&width=750&show_text=true&appId=404321486996278&height=980" width="750" height="980" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
            
    </section> 

    

    <section class="section__koalicja-obywatelska_image no-select"><img src="<?php echo get_template_directory_uri()?>/images/KO_logo.gif" class='maxwidth-image' alt="Logo koalicji obywatelskiej"></section> 
    <!-- Fifth Section End -->
